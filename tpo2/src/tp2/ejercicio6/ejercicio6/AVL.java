package tp2.ejercicio6.ejercicio6;
...
public class AVL<E extends Comparable<E>> implements AVLTDA<E> {
    ...
    // ejercicio 3
    public E min() {
        if (root == null) throw new IllegalStateException("El árbol está vacío");
    ...
    private void inOrderToList(NodoAVL<E> node, List<E> result) {
        if (node != null) {
